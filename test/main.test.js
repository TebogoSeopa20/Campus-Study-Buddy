...
describe('Mobile Menu Module', () => {
    ...
    describe('initMobileMenuToggle', () => {
        test('should initialize mobile menu toggle when button exists', () => {
            const result = initMobileMenuToggle();
            
            expect(result).toBe(document.getElementById('mobile-menu-button'));
    ...
    describe('initScrollAnimations', () => {
        test('should initialize animations with IntersectionObserver', () => {
            const result = initScrollAnimations();
            
            expect(result.animatedElements.length).toBeGreaterThan(0);
    ...
    describe('initAllMobileFeatures', () => {
        test('should initialize all features', () => {
            const result = initAllMobileFeatures();
            
            expect(result.scrollData).toBeDefined();
            expect(result.navElements).toBeDefined();
